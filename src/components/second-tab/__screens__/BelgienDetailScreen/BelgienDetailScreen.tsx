...
type Props = StackScreenProps<TabTwoParamList, 'BelgienDetailScreen'>;
export default function BelgienDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Belgien</DetailTitle>
