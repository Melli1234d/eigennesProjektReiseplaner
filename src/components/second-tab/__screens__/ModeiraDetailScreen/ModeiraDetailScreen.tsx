...
type Props = StackScreenProps<TabTwoParamList, 'ModeiraDetailScreen'>;
export default function ModeiraDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Modeira</DetailTitle>
