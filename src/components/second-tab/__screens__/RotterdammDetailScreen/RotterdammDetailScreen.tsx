...
type Props = StackScreenProps<TabTwoParamList, 'RotterdammDetailScreen'>;
export default function RotterdammDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Rotterdamm</DetailTitle>
