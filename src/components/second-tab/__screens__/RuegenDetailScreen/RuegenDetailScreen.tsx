...
type Props = StackScreenProps<TabTwoParamList, 'RuegenDetailScreen'>;
export default function RuegenDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
