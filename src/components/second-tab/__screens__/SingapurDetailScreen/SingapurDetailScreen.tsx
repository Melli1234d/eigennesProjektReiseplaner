...
type Props = StackScreenProps<TabTwoParamList, 'SingapurDetailScreen'>;
export default function SingapurDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Singapur</DetailTitle>
