...
type Props = StackScreenProps<TabTwoParamList, 'AmsterdamDetailScreen'>;
export default function AmsterdamDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Amsterdam</DetailTitle>
