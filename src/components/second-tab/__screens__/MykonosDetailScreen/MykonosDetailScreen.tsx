...
type Props = StackScreenProps<TabTwoParamList, 'MykonosDetailScreen'>;
export default function MykonosDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Mykonos</DetailTitle>
