...
type Props = StackScreenProps<TabTwoParamList, 'VancouverDetailScreen'>;
export default function VancouverDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Vancouver</DetailTitle>
