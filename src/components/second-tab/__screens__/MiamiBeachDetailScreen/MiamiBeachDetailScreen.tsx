...
type Props = StackScreenProps<TabTwoParamList, 'MiamiBeachDetailScreen'>;
export default function MiamiBeachDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Miami Beach</DetailTitle>
