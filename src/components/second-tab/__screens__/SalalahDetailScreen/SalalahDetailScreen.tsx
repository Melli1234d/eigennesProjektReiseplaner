...
type Props = StackScreenProps<TabTwoParamList, 'SalalahDetailScreen'>;
export default function SalalahDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Salalah</DetailTitle>
