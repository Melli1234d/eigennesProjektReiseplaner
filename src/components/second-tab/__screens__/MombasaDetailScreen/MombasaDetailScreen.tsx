...
type Props = StackScreenProps<TabTwoParamList, 'MombasaDetailScreen'>;
export default function MombasaDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Mombasa</DetailTitle>
