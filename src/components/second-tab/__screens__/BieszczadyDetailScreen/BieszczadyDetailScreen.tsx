...
type Props = StackScreenProps<TabTwoParamList, 'BieszczadyDetailScreen'>;
export default function BieszczadyDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Bieszczady</DetailTitle>
