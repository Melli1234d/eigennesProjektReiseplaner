...
type Props = StackScreenProps<TabTwoParamList, 'BarcelonaDetailScreen'>;
export default function BarcelonaDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Barcelona</DetailTitle>
