...
type Props = StackScreenProps<TabTwoParamList, 'JamaikaDetailScreen'>;
export default function JamaikaDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Jamaika</DetailTitle>
