...
type Props = StackScreenProps<TabTwoParamList, 'BudapestDetailScreen'>;
export default function BudapestDetailScreen({ navigation }: Props) {
	return (
		<Container>
			<DetailContainer>
				...
				<DetailTitle>Budapest</DetailTitle>
